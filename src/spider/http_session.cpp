...
{
	SPIDER_LOG(err, "{}: {} ({})", what, ec.message(), ec);
}

} // namespace

// Handles an HTTP server connection
class http_session_impl : public std::enable_shared_from_this<http_session_impl>
{
